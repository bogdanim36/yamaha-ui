...
Yamaha.prototype.getRepeatInfo = function (input) {
	var command = '<YAMAHA_AV cmd="GET"><' + input + '><Play_Control><Play_Mode><Repeat>GetParam</Repeat></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command).then(xml2js.parseStringAsync);
};

Yamaha.prototype.repeatOff = function (input) {
	var command = '<YAMAHA_AV cmd="PUT"><' + input + '><Play_Control><Play_Mode><Repeat>Off</Repeat></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};

Yamaha.prototype.repeatAll = function (input) {
	var command = '<YAMAHA_AV cmd="PUT"><' + input + '><Play_Control><Play_Mode><Repeat>All</Repeat></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};

Yamaha.prototype.repeatOne = function (input) {
	var command = '<YAMAHA_AV cmd="PUT"><' + input + '><Play_Control><Play_Mode><Repeat>One</Repeat></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};

Yamaha.prototype.getShuffleInfo= function (input) {
	var command = '<YAMAHA_AV cmd="GET"><' + input + '><Play_Control><Play_Mode><Shuffle>GetParam</Shuffle></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command).then(xml2js.parseStringAsync);
};

Yamaha.prototype.shuffleOn = function (input) {
	var command = '<YAMAHA_AV cmd="PUT"><' + input + '><Play_Control><Play_Mode><Shuffle>On</Shuffle></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
    return this.SendXMLToReceiver(command);
};

Yamaha.prototype.shuffleOff = function (input) {
	var command = '<YAMAHA_AV cmd="PUT"><' + input + '><Play_Control><Play_Mode><Shuffle>Off</Shuffle></Play_Mode></Play_Control></' + input + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};
...
Yamaha.prototype.menuCursorMove = function (listname, move) {
	...
	var command = '<YAMAHA_AV cmd="PUT"><' + listname + '><List_Control><Cursor>' + move + '</Cursor></List_Control></' + listname + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};
...
Yamaha.prototype.menuPageMove = function (listname, move) {
	...
	var command = '<YAMAHA_AV cmd="PUT"><' + listname + '><List_Control><Page>' + move + '</Page></List_Control></' + listname + '></YAMAHA_AV>';
	return this.SendXMLToReceiver(command);
};
...
Yamaha.prototype.getServerInfo = function () {
	var command = '<YAMAHA_AV cmd="GET"><SERVER><Play_Info>GetParam</Play_Info></SERVER></YAMAHA_AV>';

	return this.SendXMLToReceiver(command).then(xml2js.parseStringAsync).then(function (info) {
		var server = info.YAMAHA_AV.SERVER[0].Play_Info[0];
		return (server);
	});
};
