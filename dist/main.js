...
/* harmony import */ var _yamaha_app_component_yamaha__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./yamaha/app.component.yamaha */ "./src/app/yamaha/app.component.yamaha.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(jsonSrv, changeDetectorRef, media, deviceService, zone) {
        ...
        this.yamaha = new _yamaha_app_component_yamaha__WEBPACK_IMPORTED_MODULE_5__["Yamaha"](jsonSrv);
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        if (this.isMobile)
            jquery__WEBPACK_IMPORTED_MODULE_3__(this.yamahaEl.nativeElement).closest("body").addClass("app-is-mobile");
    ...
    AppComponent.prototype.ngAfterViewChecked = function () {
        var height = jquery__WEBPACK_IMPORTED_MODULE_3__(this.yamaha.element).height();
        var width = jquery__WEBPACK_IMPORTED_MODULE_3__(this.yamaha.element).width();
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_0__["MediaMatcher"], ngx_device_detector__WEBPACK_IMPORTED_MODULE_2__["DeviceDetectorService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _album_info_app_component_album_info__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./album-info/app.component.album-info */ "./src/app/album-info/app.component.album-info.ts");
/* harmony import */ var _playback_app_component_playback__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./playback/app.component.playback */ "./src/app/playback/app.component.playback.ts");
/* harmony import */ var _source_menu_app_component_source_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./source-menu/app.component.source-menu */ "./src/app/source-menu/app.component.source-menu.ts");
/* harmony import */ var _commands_app_component_commands__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./commands/app.component.commands */ "./src/app/commands/app.component.commands.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _commands_app_component_commands__WEBPACK_IMPORTED_MODULE_10__["CommandsComponent"],
                _playback_app_component_playback__WEBPACK_IMPORTED_MODULE_8__["PlaybackComponent"],
                _album_info_app_component_album_info__WEBPACK_IMPORTED_MODULE_7__["AlbumInfoComponent"],
                _source_menu_app_component_source_menu__WEBPACK_IMPORTED_MODULE_9__["SourceMenuComponent"]
            ],
            imports: [
...
/* harmony import */ var _extensions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../extensions */ "./src/app/extensions.ts");
/* harmony import */ var _extensions__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_extensions__WEBPACK_IMPORTED_MODULE_5__);
...
var Yamaha = /** @class */ (function () {
    function Yamaha(jsonSrv) {
        ...
        this.api = jsonSrv;
        var self = this;
        this.api.getJSON('./assets/yamaha.json').subscribe(function (data) {
            self.config = data;
    ...
    Yamaha.prototype.getBasicInfo = function (zone, delay, callback) {
        ...
        this.api.runningTask = setTimeout(function () {
            ...
            self.api.action('getBasicInfo', 'get', { zone: zone }).subscribe(function (response) {
                if (!response.status) {
                    document.title = _app_shared__WEBPACK_IMPORTED_MODULE_0__["AppShared"].apiError;
                    _this.status.playback = null;
                    _this.status.menu = null;
                }
                else
